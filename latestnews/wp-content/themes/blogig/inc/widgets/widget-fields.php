...
function blogig_widget_fields( $instance, $args, $field_value ) {
    echo '<div class="blogig-widget-field blogig-' .esc_html( $args['type'] ). '-field">';
        switch( $args['type'] ) {
            case 'number' : ?>
            ...
            case 'icon-text' : $field_value_formatted = json_decode( $field_value );
                               $icons = blogig_get_tabbed_icon_classes();
             ?>
                        <h2 class="title"><?php echo esc_html( $args['title'] ); ?></h2>
                        <?php
                            if( isset( $args['description'] ) ) {
            ...
            case 'url' : ?>
                            ...
                            ?>
                            <input class="widefat" id="<?php echo $instance->get_field_id( $args['name'] ); ?>" name="<?php echo $instance->get_field_name( $args['name'] ); ?>" type="url" placeholder="<?php esc_attr_e( 'Add url here . .', 'blogig' ); ?>" value="<?php echo esc_url( $field_value ); ?>" />
                <?php
                break;
            case 'textarea' : ?>
                            <h2 class="title"><?php echo esc_html( $args['title'] ); ?></h2>
            ...
            case 'upload' : ?>
                            ...
                            <div class="upload-trigger<?php if( $field_value ) echo ' selected'; ?>">
                                <span><?php esc_html_e( 'Add image', 'blogig' ); ?></span>
                            </div>
                            <div class="upload-buttons<?php if( ! $field_value ) echo ' not-selected'; ?>">
                                ...
                                <button class="button button-link-delete remove-image"><?php esc_html_e( 'Remove image', 'blogig' ); ?></button>
                            </div>
        ...
        ?>
            ...
            case 'select-two':
                ...
                break;
            default : esc_html( 'Undefined control field', 'blogig' );
                break;
        }
    echo '</div>';
}
...
function blogig_sanitize_widget_fields( $widget_field, $new_instance ) {
