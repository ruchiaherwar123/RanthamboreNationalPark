 ...
 * Description: A smart breadcrumb menu plugin embedded with <a href="https://schema.org">Schema.org</a> microdata that can handle variations in site structure more accurately than any other breadcrumb plugin for WordPress. Insert into your theme with the <code>breadcrumb_trail()</code> template tag.
 * Version:     1.1.0
...
function breadcrumb_trail_setup() {
	load_plugin_textdomain( 'blogig', false, trailingslashit( dirname( plugin_basename( __FILE__ ) ) ) . 'lang' );
}
