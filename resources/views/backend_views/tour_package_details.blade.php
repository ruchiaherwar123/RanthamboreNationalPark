                              ...
                              <table class="table table-bordered table-hover" id="dataTableExample1">
                                 ...
                                 <thead>
                                    ...
                                    <tr class="info">
                                       ...
                                       <th>No. of Nights Stay in Wildlife Resort</th>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <img src="{{ asset('public/tourimage/'.$image[0])}}" class="img-circle" width="50" height="50">

                                        </td>

                                        <td>

                                          <a href="{{url('tour_view_details/'. $data->id)}}" class="btn btn-primary btn-sm"><i

                                          class="fa fa-eye"></i></a>



                                          <a href="{{route('tour_edit_details',['id' => $data->id])}}" class="btn btn-primary btn-sm"><i
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <form class="form-horizontal"
                                                                        ...
                                                                        action="{{ route('destroy_tour', ['TourPackage' => $data->id]) }}"
